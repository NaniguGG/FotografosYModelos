namespace Shootr.Migrations
{
    ...
    public partial class init : DbMigration
    {
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        Url = c.String(),
                        MyUserInfoId = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.MyUserInfoes", t => t.MyUserInfoId, cascadeDelete: true)
                .Index(t => t.MyUserInfoId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Fotoes", "MyUserInfoId", "dbo.MyUserInfoes");
            ...
            DropIndex("dbo.Fotoes", new[] { "MyUserInfoId" });
